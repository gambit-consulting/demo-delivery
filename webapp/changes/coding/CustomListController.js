...
sap.ui.define([
	...
	function (
		...
		"use strict";
		return ControllerExtension.extend("ManagePurchaseOrderAdp.CustomListController", {
			// metadata: {
			...
			// 	 * @memberOf ManagePurchaseOrderAdp.CustomListController
			// 	 */
			 	onInit: function() {
                    console.log("This is a adaption test");
			 	},
